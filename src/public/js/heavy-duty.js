 ...
 <div class="container mt-4">
    ...
    <div class="container mt-4">
      ...
      <div class="col-lg-4 px-2">
        ...
        <p class="lead" >Los amortiguadores Heavy-duty logran la estabilidad que se logró al fabricar el vehículo, con las mejores válvulas de amortiguación internas que ayudan a restablecer el manejo. Esto es muy importante
        para lograr el perfecto funcionamiento de las otras partes del automóvil.</p>
      </div><!-- /.col-lg-4 px-4 -->
      <div class="col-lg-4 px-2">
        ...
        <p class="lead">Los amortiguadores de heavy-duty obtienen mejores estadísticas de amortiguación que los diseños convencionales. 
        Proporciona las mejores capacidades de manejo y control a su vehículo, lo que lo convierte en uno de los más confiables del mercado.</p>
      </div><!-- /.col-lg-4 px-4 -->
      <div class="col-lg-4 px-2">
        ...
        <p class="lead">Es posible que los amortiguadores usados, viejos y económicos no brinden la respuesta correcta cuando se trata de
         conducir el vehículo. Los Heavy-duty pesado afirman ser los mejores amortiguadores de su tipo, con las mejores respuestas de
          dirección para un mejor control.</p>
      </div><!-- /.col-lg-4 px-4 -->
    </div>
    </div><!-- /.row -->
    ...
    <div class="container mt-4">
      <div class="row">
        <div class="col-lg-4 px-2">
          ...
          <p class="lead">Los amortiguadores de Heavy-duty están diseñados para tener todo en un solo tubo, separando el gas del aceite para un mejor rendimiento y un mayor nivel de respuesta.</p>
        </div><!-- /.col-lg-4 px-4 -->
        <div class="col-lg-4 px-2">
          ...
          <p class="lead">Los amortiguadores Heavy-duty están diseñados para vehículos con llantas grandes y brindan una capacidad de amortiguación adicional en cada esquina; y esto lo convierte en uno de los mejores amortiguadores del mercado para los más pesados. </p>
        </div><!-- /.col-lg-4 px-4 -->
        <div class="col-lg-4 px-2">
      ...
      <section id="image-product">
        <div class="d-flex flex-row mt-5">
            ...
            Los amortiguadores  heavy-duty están diseñados en un solo tubo, teniendo ventajas de rendimiento adicionales sobre el diseño tradicional de dos tubos, lo que hace que tenga un mayor control de las direcciones, una alineación perfecta y <strong> soporte en cada esquina hasta un 20% más de lo que pueda soportar otros amortiguadores de su tipo </strong>. Funcionan perfectamente para ser el reemplazo de vehículos que tenían amortiguadores convencionales de dos o un tubo de fábrica. <br> <br>
            Los amortiguadores de servicio pesado son de gas de alta presión que incluye solo un cilindro dividido en dos cámaras, una llena de gas presurizado y la otra superior, con fluido hidráulico, separando el gas y el aceite por un pistón flotante que evita que se produzca aireación o cavitación. También tiene un conjunto de válvula de pistón que está conectado al vástago que está en la parte fluida del tubo. <br> <br>
            Todas estas tecnologías hacen de este tipo de amortiguadores uno de los mejores de su tipo ya que está diseñado para evitar los problemas y averías que suelen tener los amortiguadores convencionales.
            </p>
