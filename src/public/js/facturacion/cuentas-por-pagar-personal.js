...
fetch("/ver-anio-administrativo-personal", {
    method: "POST",
  })
    .then((response) => {
...
const actualizarCuentaPorPagar = async (data) => {
    return await fetch("/actualizar-pago-de-cuentas-por-pagar-personal", {
        method: "POST",
...
const PagarCuenta = async (data) => {
    return await fetch("/registrar-pago-pendiente-personal", {
        method: "POST",
        body: JSON.stringify(data),
        headers: {
        "Content-type": "application/json; charset=utf-8",
...
const EditarCuenta = async (data) => {
    return await fetch("/editar-cuenta-pagar-personal", {
        method: "POST",
        body: JSON.stringify(data),
        headers: {
        "Content-type": "application/json; charset=utf-8",
...
const EliminarCuenta = async (data) => {
    return await fetch("/eliminar-cuenta-pagar-personal", {
        method: "POST",
        body: JSON.stringify(data),
        headers: {
        "Content-type": "application/json; charset=utf-8",
...
const AgregarCuentaPagar = async (data) => {
    return await fetch("/agregar-cuenta-pagar-personal", {
        method: "POST",
        body: JSON.stringify(data),
        headers: {
        "Content-type": "application/json; charset=utf-8",
