  ...
  if(localStorage.getItem("Lenguajes") == "Spanish"){
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="/css/assets/strut_and_boot.jpg" class="carousel_image zoom-efect" alt="">
        <div class="container">
          <div class="carousel-caption text-start text-light">
            <h1 id="title">Bases de amortiguador y botas.</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section id="image-product">
      ...
      <div class="d-flex flex-row mt-5">
        <div class="row">
          <div class="col-md-6">
          <p class="lead">
            Reduce la suspensión, los ruidos de la carretera y las vibraciones.
            las bases de montaje brindan una dirección más suave y ayudan a mantener la alineación del extremo
            delantero construido con un diseño y una calidad que igualan o superan la calidad del equipo original.
            <br><br>

            Nuestras botas mantienen los contaminantes que causan fugas lejos de los ejes de puntal pulidos,
            están construidos con un diseño y una calidad que igualan o superan a los del equipo original.
            Cuenta con un parachoques que limita el recorrido para evitar que el puntal toque fondo.
            <br><br>
          ...
          <div class="col-md-6">
            ...
            <img src="/css/assets/strutmountandboot.png" width="450px" height="500px" alt="">
          </div>
        </div>
      </div>
